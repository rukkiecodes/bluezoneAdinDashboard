...
if (transac)
  (async () => {
    ...
    let _transactions = response.data.transactions.slice(0, 5)
    ...
    if (_transactions.length > 0) {
      _transactions.forEach(i => {
        transac.innerHTML += `
                            <li>
                                <a href="#" class="item">
                                    <div class="icon-box">
                                        <img src="./assets/img/bitcoin.png" width="30" height="30"/>

                                    </div>
                                    <div class="in">
                                        <div>
                                            <strong>Bitcoin</strong>
                                            <div class="text-small text-secondary">Deposit</div>
                                        </div>
                                        <div class="text-end">
      ...
      transac.innerHTML += ` <div class="section mt-2"
